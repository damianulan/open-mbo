...
class Pages extends Seeder
{
    ...
    {
        return array(
            'settings.server_info' => array(
                'pl' => 'Informacje o serwerze',
                'en' => 'Server info',
            ),
            'settings.git_status' => array(
                'pl' => 'Git status',
                'en' => 'Git status',
            ),
            ...
            'settings.cache_clear' => array(
                'pl' => 'Wyczyść cache',
                'en' => 'Clear cache',
            ),
            'settings.timezone' => array(
                'pl' => 'Strefa czasowa',
                'en' => 'Timezone',
            ),
            ...
            'settings.phpinfo' => array(
                'pl' => 'PHP Info',
                'en' => 'PHP info',
            ),
            'settings.telescope' => array(
                'pl' => 'Teleskop',
                'en' => 'Telescope',
            ),
            'home.my_objectives' => array(
                'pl' => 'Moje cele',
                'en' => 'My objectives',
            ),
            'home.my_campaigns' => array(
                'pl' => 'Moje kampanie',
                'en' => 'My campaigns',
            ),
            'errors.500.title' => array(
                'pl' => 'Wewnętrzny błąd serwera',
                'en' => 'Internal server error',
            ),
            'errors.500.paragraph' => array(
            ...
            'errors.503.title' => array(
                'pl' => 'Usługa niedostępna',
                'en' => 'Service unavailable',
            ),
            'errors.503.paragraph' => array(
            ...
            'errors.401.title' => array(
                'pl' => 'Dostęp nieautoryzowany',
                'en' => 'Unauthorized access',
            ),
            'errors.401.paragraph' => array(
                'pl' => '',
            ),
            'errors.419.title' => array(
                'pl' => 'Sesja wygasła',
                'en' => 'Session expired',
            ),
            'errors.419.paragraph' => array(
