...
'viewTelescope','mbo-objective-delete','settings-general','mbo-objective-milestones','users-view-all',
'mbo-campaign-manage','settings-integrations','management-mbo-categories','mbo-objective-view','mbo-objective-create',
'mbo-objective-update','management-roles','users-impersonate','management-mbo-templates','settings-server',
'telescope-view','users-teams','mbo-objective-realization','reports-view','users-list',
'management-structure','users-restore','users-edit','management-recovery','management-reports',
'management-users','mbo-campaign-update','mbo-campaign-view','users-delete','users-view',
'mbo-campaign-create','mbo-campaign-delete','settings-logs','maintenance','mbo-view-all-objectives',
'users-create','settings-modules','management-notifications','viewAny','preview',
...
'layouts.portal.scripts','layouts.portal.topbar','mailcatchall::receivers.html','mailcatchall::receivers.text','pages.components.dashboard',
...
'datatables::print','datatables::scout','datatables::script','formforge::components.button','formforge::components.checkbox',
'formforge::components.daterange','formforge::components.datetime','formforge::components.file','formforge::components.input','formforge::components.select',
'formforge::components.trix','formforge::components.trix-field','formforge::label','formforge::templates.horizontal','laravel-exceptions-renderer::components.card',
...
'buttons.tile_view','commons.notifications','facades.datatables.select_columns','faker.type_of_contract.uop','faker.type_of_contract.uod',
'faker.type_of_contract.uz','faker.type_of_contract.b2b','fields.firstname','fields.lastname','fields.firstname_lastname',
'fields.email','fields.login','fields.password','fields.status','fields.action',
'fields.name','fields.title','fields.category','fields.created_at','fields.updated_at',
...
'forms.mbo.categories.shortname','forms.mbo.categories.description','forms.mbo.categories.coordinators','gates.roles_plural','gates.roles.root',
'gates.roles.support','gates.roles.admin','gates.roles.admin_mbo','gates.roles.manager','gates.roles.supervisor',
'gates.roles.employee','logging.columns.causer','logging.columns.subject','logging.columns.subject_type','logging.columns.created_at',
...
'mbo.info.objective_admins','mbo.campaign','mbo.campaigns','mbo.campaign_coordinators','mbo.objective',
'mbo.objectives','mbo.objective_admins','mbo.category_admins','mbo.enroled_users','menus.management.mbo.objectives.index',
'menus.management.mbo.objectives.create','menus.management.mbo.objectives.edit','menus.management.mbo.categories.index','menus.management.mbo.categories.create','menus.management.mbo.categories.edit',
'models.App\\Models\\Core\\User','models.App\\Models\\MBO\\Campaign','notifications.app.campaign_assignment','notifications.commons.empty','pages.settings.server_info',
'pages.settings.git_status','pages.settings.debugging','pages.settings.environment','pages.settings.build','pages.settings.release',
'pages.settings.cache_clear','pages.settings.timezone','pages.settings.general','pages.settings.branding','pages.settings.modules',
'pages.settings.phpversion','pages.settings.info','pages.settings.phpinfo','pages.settings.telescope','pages.errors.500.title',
'pages.errors.500.paragraph','pages.errors.503.title','pages.errors.503.paragraph','pages.errors.404.title','pages.errors.404.paragraph',
'pages.errors.403.title','pages.errors.403.paragraph','pages.errors.401.title','pages.errors.401.paragraph','pages.errors.419.title',
'pages.errors.419.paragraph','pages.errors.common','pagination.showing','pagination.to','pagination.of',
'pagination.results','vocabulary.yes','vocabulary.no','vocabulary.search','vocabulary.you',
'vocabulary.no_data','vocabulary.turned_on_male','vocabulary.turned_on_female','vocabulary.turned_on_other','vocabulary.turned_off_male',
'vocabulary.turned_off_female','vocabulary.turned_off_other','vocabulary.select_choose','vocabulary.search_no_results','vocabulary.enter_address',
'vocabulary.hello','vocabulary.not_applicable','vocabulary.pnts','vocabulary.column','vocabulary.columns',
