...
'components.forms.edit','components.forms.label','components.mbo.campaign-card','components.mbo.campaign-summary','components.mbo.objective-card',
...
'formforge::components.select','formforge::components.trix','formforge::components.trix-field','formforge::label','formforge::templates.horizontal',
...
'livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind','mailcatchall::receivers.html',
'mailcatchall::receivers.text','notifications::email','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default',
'pagination::semantic-ui','pagination::simple-bootstrap-4','pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind',
'pagination::tailwind',);
...
'vocabulary.langs.pl','vocabulary.langs.en','formforge::components.buttons.save','formforge::components.buttons.choose_file','formforge::components.buttons.enter_address',
'formforge::components.typography.bold','formforge::components.typography.italic','formforge::components.typography.hiperlink','formforge::components.typography.quote','formforge::components.typography.li',
'formforge::components.typography.ol','formforge::components.typography.link','formforge::components.typography.unlink','formforge::forms.placeholders.choose_daterange_from','formforge::forms.placeholders.choose_daterange_to',
'formforge::forms.placeholders.choose_date','formforge::forms.placeholders.choose_birthdate','formforge::forms.placeholders.choose_time','formforge::forms.placeholders.choose_datetime','formforge::forms.yes',
'formforge::forms.no','backup::notifications.exception_message','backup::notifications.exception_trace','backup::notifications.exception_message_title','backup::notifications.exception_trace_title',
