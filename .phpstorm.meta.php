...
'sanctum.csrf-cookie','livewire.update','generated::rGeQdMTMzQFRicZk','generated::fjx3zj5SJpGMYL4a','livewire.upload-file',
'livewire.preview-file','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','generated::msbRnQDT9jS20o8p',
'login','generated::WFJpzzLYvKnOC32K','logout','register','generated::HknC70NS1QG4IGOU',
'password.request','password.email','password.reset','password.update','password.confirm',
'generated::d50mcNYCcyvEMJm6','dashboard','users.index','users.store','users.create',
...
'datatables::options','datatables::print','datatables::scout','datatables::script','formforge::components.button',
'formforge::components.checkbox','formforge::components.daterange','formforge::components.datetime','formforge::components.file','formforge::components.input',
'formforge::components.select','formforge::components.trix','formforge::components.trix-field','formforge::edit','formforge::label',
'formforge::templates.horizontal','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
...
'mailcatchall::receivers.html','mailcatchall::receivers.text','notifications::email','pagination::bootstrap-4','pagination::bootstrap-5',
