...
'viewTelescope','viewAny','preview','view','create',
...
'campaigns.users.delete','objectives.show','general.get_modal','datatables.save_columns','ajax.get_model_instance',
'fallback',);
...
'components.nocontent-page','components.notification-dropdown','components.unavailable-page','components.utilities.card_progressbar','components.utilities.notification-item',
'datatables-export::export-button','datatables-export::export-email','datatables::editor','datatables::editor','datatables::function',
'datatables::function','datatables::options','datatables::options','datatables::print','datatables::print',
'datatables::script','datatables::script','errors.401','errors.403','errors.404',
'errors.419','errors.500','errors.503','errors.error','errors.master',
'layouts.components.alerts','layouts.portal.footer','layouts.portal.header','layouts.portal.master','layouts.portal.scripts',
'layouts.portal.sidebar','layouts.portal.topbar','mailcatchall::receivers.html','mailcatchall::receivers.text','pages.components.dashboard',
'pages.dashboard','pages.management.index','pages.management.objectives.edit','pages.management.organization.company.action','pages.management.organization.company.edit',
'pages.management.organization.company.index','pages.management.organization.index','pages.mbo.campaigns.edit','pages.mbo.campaigns.index','pages.mbo.campaigns.nav',
'pages.mbo.campaigns.show','pages.mbo.categories.action','pages.mbo.categories.edit','pages.mbo.categories.index','pages.mbo.objectives.show',
'pages.profile.edit','pages.profile.index','pages.profile.nav','pages.settings.index','pages.settings.logs',
'pages.settings.my_logs','pages.settings.server','pages.users.action','pages.users.edit','pages.users.index',
'pages.users.show','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui',
...
'vendor.apexcharts.container','vendor.apexcharts.script','vendor.datatables-export.export-button','vendor.datatables-export.export-email','vendor.datatables.editor',
'vendor.datatables.function','vendor.datatables.options','vendor.datatables.print','vendor.datatables.script','vendor.mailcatchall.receivers.html',
'vendor.mailcatchall.receivers.text','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.default','vendor.pagination.semantic-ui',
...
'apexcharts::container','apexcharts::script','breadcrumbs::bootstrap4','breadcrumbs::bootstrap5','breadcrumbs::bulma',
'breadcrumbs::foundation6','breadcrumbs::materialize','breadcrumbs::tailwind','breadcrumbs::uikit','datatables-export::export-button',
...
'livewire::simple-tailwind','livewire::tailwind','mailcatchall::receivers.html','mailcatchall::receivers.text','notifications::email',
...
'fields.firstname','fields.lastname','fields.firstname_lastname','fields.email','fields.login',
'fields.password','fields.status','fields.action','fields.name','fields.title',
'fields.category','fields.created_at','fields.updated_at','fields.enums.individual','fields.enums.team',
...
'vocabulary.search_no_results','vocabulary.enter_address','vocabulary.hello','vocabulary.not_applicable','vocabulary.column',
'vocabulary.columns','vocabulary.typography.bold','vocabulary.typography.italic','vocabulary.typography.hiperlink','vocabulary.typography.quote',
'vocabulary.typography.li','vocabulary.typography.ol','vocabulary.typography.link','vocabulary.typography.unlink','vocabulary.langs.pl',
'vocabulary.langs.en','backup::notifications.exception_message','backup::notifications.exception_trace','backup::notifications.exception_message_title','backup::notifications.exception_trace_title',
