...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'formforge.default_template' => 'string',
...
'viewTelescope','settings-integrations','mbo-objective-view','mbo-view-all-objectives','users-restore',
'users-teams','mbo-objective-update','telescope-view','settings-server','management-mbo-templates',
'management-roles','mbo-campaign-manage','users-edit','mbo-objective-realization','settings-logs',
'management-users','users-list','users-impersonate','mbo-campaign-view','management-recovery',
'users-delete','management-reports','management-notifications','management-mbo-categories','mbo-objective-delete',
'maintenance','users-view','mbo-campaign-delete','settings-general','mbo-campaign-update',
'mbo-campaign-create','mbo-objective-create','reports-view','management-structure','users-create',
'settings-modules','users-view-all','mbo-objective-milestones','viewAny','preview',
...
'formforge.default_template','hashing.driver','hashing.bcrypt.rounds','hashing.argon.memory','hashing.argon.threads',
...
'ide-helper.macroable_traits','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.host','mail.mailers.smtp.port',
...
'mail.markdown.theme','mail.markdown.paths','mailcatchall.enabled','mailcatchall.receiver','mailcatchall.event',
'mailcatchall.add_receivers_to_text','mailcatchall.add_receivers_to_html','purifier.encoding','purifier.finalize','purifier.ignoreNonStrings',
...
'settings.repositories.database.model','settings.repositories.database.table','settings.repositories.database.connection','settings.encoder','settings.decoder',
...
'settings.global_casts.DateTimeZone','settings.global_casts.Spatie\\LaravelData\\Data','settings.auto_discover_settings','settings.discovered_settings_cache_path','telescope.enabled',
...
'view.paths','view.compiled','concurrency.default','logging.default','logging.deprecations.channel',
...
'logging.channels.null.handler','logging.channels.emergency.path','laravel-impersonate.session_key','laravel-impersonate.session_guard','laravel-impersonate.session_guard_using',
...
'query-builder.convert_relation_names_to_snake_case_plural','datatables-fractal.includes','datatables-fractal.serializer','tinker.commands','tinker.alias',
'tinker.dont_alias',);
...
'components.forms.edit','components.forms.label','components.layout.tile-button','components.mbo.campaign-card','components.mbo.campaign-summary',
'components.mbo.campaign.campaign-users-list','components.mbo.objective-card','components.mbo.objectives.objective-users-list','components.mbo.objectives.objectives-list','components.menus.item',
'components.menus.menubar','components.menus.sidebar','components.modals.campaigns.add_objectives','components.modals.campaigns.add_users','components.modals.objectives.add_child',
...
'layouts.portal.topbar','mailcatchall::receivers.html','mailcatchall::receivers.text','pages.components.dashboard','pages.dashboard',
'pages.management.index','pages.management.objectives.edit','pages.management.organization.company.action','pages.management.organization.company.edit','pages.management.organization.company.index',
'pages.management.organization.index','pages.mbo.campaigns.edit','pages.mbo.campaigns.index','pages.mbo.campaigns.nav','pages.mbo.campaigns.show',
'pages.mbo.categories.action','pages.mbo.categories.edit','pages.mbo.categories.index','pages.mbo.objectives.show','pages.profile.edit',
'pages.profile.index','pages.profile.nav','pages.settings.index','pages.settings.logs','pages.settings.my_logs',
'pages.settings.server','pages.users.action','pages.users.edit','pages.users.index','pages.users.show',
'pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui','pagination::simple-bootstrap-4',
'pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','vendor.apexcharts.container',
'vendor.apexcharts.script','vendor.datatables-export.export-button','vendor.datatables-export.export-email','vendor.datatables.editor','vendor.datatables.function',
'vendor.datatables.options','vendor.datatables.print','vendor.datatables.script','vendor.mailcatchall.receivers.html','vendor.mailcatchall.receivers.text',
...
'vendor.pagination.simple-bootstrap-5','vendor.pagination.simple-default','vendor.pagination.simple-tailwind','vendor.pagination.tailwind','apexcharts::container',
'apexcharts::script','breadcrumbs::bootstrap4','breadcrumbs::bootstrap5','breadcrumbs::bulma','breadcrumbs::foundation6',
'breadcrumbs::materialize','breadcrumbs::tailwind','breadcrumbs::uikit','datatables-export::export-button','datatables-export::export-email',
'datatables::editor','datatables::function','datatables::functions.batch_remove','datatables::options','datatables::print',
'datatables::scout','datatables::script','formforge::components.button','formforge::components.checkbox','formforge::components.daterange',
'formforge::components.datetime','formforge::components.file','formforge::components.input','formforge::components.select','formforge::components.trix',
'formforge::components.trix-field','formforge::label','formforge::templates.horizontal','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'menus.my_objectives.index','menus.profile.index','menus.profile.edit','menus.profile.reset','menus.profile.personal_data',
'menus.profile.settings','menus.profile.logs','menus.settings.index','menus.settings.general.index','menus.settings.modules.index',
'menus.settings.integrations.index','menus.settings.server.index','menus.settings.logs.index','menus.settings.help.index','menus.management.index',
'menus.management.users.index','menus.management.organization.index','menus.management.organization.company.index','menus.management.teams.index','menus.management.objectives.index',
'menus.management.objectives.create','menus.management.objectives.edit','menus.management.objectives.categories.index','menus.management.restoring.index','menus.campaigns.index',
'menus.campaigns.create','menus.campaigns.edit','menus.users.index','menus.users.edit','menus.users.create',
'menus.users.show','menus.info.profile.logs','alerts.success.operation','alerts.error.invalid_role','alerts.error.no_permission',
'alerts.error.ajax','alerts.error.operation','alerts.warning.operation','alerts.info.maintenance','alerts.info.env_local',
'alerts.info.env_development','alerts.info.debugging','alerts.settings.success.cache_clear','alerts.settings.success.mail_update','alerts.settings.success.general',
'alerts.settings.error.cache_clear','alerts.settings.error.mail_update','alerts.settings.error.general','alerts.campaigns.success.create','alerts.campaigns.success.edit',
'alerts.campaigns.success.objective_added','alerts.campaigns.success.objective_deleted','alerts.campaigns.success.users_added','alerts.campaigns.success.users_deleted','alerts.campaigns.error.create',
'alerts.campaigns.error.edit','alerts.campaigns.error.objective_added','alerts.campaigns.error.objective_deleted','alerts.campaigns.error.users_added','alerts.campaigns.error.users_deleted',
'alerts.objectives.error.overdued','alerts.users.success.create','alerts.users.success.edit','alerts.users.success.blocked','alerts.users.success.unblocked',
'alerts.users.success.delete','alerts.users.error.create','alerts.users.error.edit','alerts.users.error.delete','alerts.users.warning.user_is_root',
'alerts.users.info.block','alerts.users.info.delete','alerts.objective_template.success.create','alerts.objective_template.success.edit','alerts.objective_template.success.delete',
'alerts.objective_template.error.create','alerts.objective_template.error.edit','alerts.objective_template.error.delete','alerts.objective_categories.success.create','alerts.objective_categories.success.edit',
'alerts.objective_categories.success.delete','alerts.objective_categories.error.create','alerts.objective_categories.error.edit','alerts.objective_categories.error.delete','alerts.objective_categories.info.delete',
'alerts.datatables.save_columns.error_data','alerts.datatables.save_columns.error','auth.login_info','auth.maintenance_info','buttons.add',
'buttons.create','buttons.remove','buttons.delete','buttons.suspend','buttons.follow',
'buttons.favourite','buttons.edit','buttons.like','buttons.reject','buttons.accept',
'buttons.save','buttons.save_changes','buttons.cancel','buttons.assign','buttons.revoke',
'buttons.block','buttons.unblock','buttons.close','buttons.summary','buttons.hide',
'buttons.unhide','buttons.profile_show','buttons.favourites_add','buttons.favourites_remove','buttons.reset_password',
'buttons.ok','buttons.ok_understand','buttons.choose_file','buttons.redirect_back','buttons.redirect_login',
'buttons.create_template','buttons.impersonate','buttons.impersonate_out','buttons.enrol_users','buttons.list_view',
'buttons.tile_view','facades.datatables.select_columns','faker.type_of_contract.uop','faker.type_of_contract.uod','faker.type_of_contract.uz',
'faker.type_of_contract.b2b','fields.firstname','fields.lastname','fields.firstname_lastname','fields.email',
'fields.login','fields.password','fields.status','fields.action','fields.name',
'fields.title','fields.category','fields.created_at','fields.updated_at','fields.enums.m',
'fields.enums.f','fields.enums.o','forms.generic.password','forms.generic.login','forms.generic.email',
'forms.settings.general.site_name','forms.settings.general.theme','forms.settings.general.lang','forms.settings.server.mail_host','forms.settings.server.mail_port',
'forms.settings.server.mail_username','forms.settings.server.mail_encryption','forms.settings.server.mail_from_address','forms.settings.server.mail_from_name','forms.settings.server.mail_catchall_enabled',
'forms.settings.server.mail_catchall_receiver','forms.placeholders.choose_date','forms.placeholders.choose_birthdate','forms.placeholders.choose_time','forms.placeholders.choose_datetime',
'forms.placeholders.choose_daterange_from','forms.placeholders.choose_daterange_to','forms.campaigns.name','forms.campaigns.period','forms.campaigns.description',
'forms.campaigns.definition','forms.campaigns.disposition','forms.campaigns.realization','forms.campaigns.evaluation','forms.campaigns.self_evaluation',
'forms.campaigns.completed','forms.campaigns.terminated','forms.campaigns.canceled','forms.campaigns.in_progress','forms.campaigns.pending',
'forms.campaigns.info.definition','forms.campaigns.info.disposition','forms.campaigns.info.realization','forms.campaigns.info.evaluation','forms.campaigns.info.self_evaluation',
'forms.campaigns.info.completed','forms.campaigns.info.terminated','forms.campaigns.info.canceled','forms.campaigns.info.in_progress','forms.campaigns.info.pending',
'forms.campaigns.coordinators','forms.campaigns.draft','forms.campaigns.manual','forms.campaigns.users.add','forms.users.avatar',
'forms.users.firstname','forms.users.lastname','forms.users.email','forms.users.gender','forms.users.birthday',
'forms.users.supervisors','forms.users.roles','forms.mbo.objectives.category','forms.mbo.objectives.template','forms.mbo.objectives.name',
'forms.mbo.objectives.description','forms.mbo.objectives.draft','forms.mbo.objectives.deadline','forms.mbo.objectives.weight','forms.mbo.objectives.type',
'forms.mbo.objectives.expected','forms.mbo.objectives.award','forms.mbo.objectives.info.deadline','forms.mbo.objectives.info.weight','forms.mbo.objectives.info.expected',
'forms.mbo.objectives.info.award','forms.mbo.objectives.info.draft','forms.mbo.categories.name','forms.mbo.categories.template_count','forms.mbo.categories.shortname',
'forms.mbo.categories.description','forms.mbo.categories.coordinators','gates.roles_plural','gates.roles.root','gates.roles.support',
'gates.roles.admin','gates.roles.admin_mbo','gates.roles.manager','gates.roles.supervisor','gates.roles.employee',
'globals.notifications','logging.columns.causer','logging.columns.subject','logging.columns.subject_type','logging.columns.created_at',
'logging.columns.event','logging.columns.description','logging.events.created','logging.events.updated','logging.events.logged_out',
'logging.events.auth_attempt_success','logging.events.auth_attempt_fail','logging.events.deleted','logging.log_name.system','logging.log_name.auth',
'logging.log_name.model','logging.description.created','logging.description.updated','logging.description.deleted','logging.description.auth_attempt_success',
'logging.description.auth_attempt_fail','logging.description.auth_logout','logging.description.notification_sent','logging.model_mapping.App\\Models\\MBO\\ObjectiveTemplate','logging.model_mapping.App\\Models\\MBO\\Objective',
'logging.model_mapping.App\\Models\\MBO\\Campaign','logging.model_mapping.App\\Models\\MBO\\ObjectiveTemplateCategory','logging.model_mapping.App\\Models\\MBO\\UserCampaign','logging.model_mapping.App\\Models\\MBO\\UserObjective','logging.route_mapping.App\\Models\\MBO\\ObjectiveTemplate',
'logging.route_mapping.App\\Models\\MBO\\Objective','logging.route_mapping.App\\Models\\MBO\\Campaign','logging.route_mapping.App\\Models\\MBO\\UserObjective','logging.route_mapping.App\\Models\\MBO\\UserCampaign','logging.route_mapping.App\\Models\\MBO\\ObjectiveTemplateCategory',
'mbo.buttons.add_objective','mbo.info.no_objectives_added','mbo.info.no_users_added','mbo.info.no_c_coordinators_added','mbo.info.no_category_admins_added',
'mbo.info.objective_admins','mbo.info.campaign_related','mbo.objective_status.unstarted','mbo.objective_status.progress','mbo.objective_status.completed',
'mbo.objective_status.passed','mbo.objective_status.failed','mbo.campaign','mbo.campaigns','mbo.campaign_coordinators',
'mbo.objective','mbo.objective_admins','mbo.category_admins','mbo.enroled_users','mbo.objectives.index',
'mbo.objectives.users.inprogress','mbo.objectives.users.completed','menus.management.organization.companies.index','menus.management.organization.departments.index','menus.management.organization.positions.index',
'menus.management.organization.contracts.index','menus.management.creator.index','menus.management.mbo.objectives.index','menus.management.mbo.objectives.create','menus.management.mbo.objectives.edit',
'menus.management.mbo.categories.index','menus.management.mbo.categories.create','menus.management.mbo.categories.edit','models.App\\Models\\Core\\User','models.App\\Models\\MBO\\Campaign',
'models.App\\Models\\MBO\\Objective','notifications.app.campaign_assignment','notifications.info.empty','pages.settings.server_info','pages.settings.git_status',
'pages.settings.debugging','pages.settings.environment','pages.settings.build','pages.settings.release','pages.settings.cache_clear',
'pages.settings.timezone','pages.settings.general','pages.settings.branding','pages.settings.modules','pages.settings.phpversion',
'pages.settings.info','pages.settings.phpinfo','pages.settings.telescope','pages.errors.500.title','pages.errors.500.paragraph',
'pages.errors.503.title','pages.errors.503.paragraph','pages.errors.404.title','pages.errors.404.paragraph','pages.errors.403.title',
'pages.errors.403.paragraph','pages.errors.401.title','pages.errors.401.paragraph','pages.errors.419.title','pages.errors.419.paragraph',
'pages.errors.common','pagination.showing','pagination.to','pagination.of','pagination.results',
'vocabulary.yes','vocabulary.no','vocabulary.search','vocabulary.you','vocabulary.no_data',
'vocabulary.turned_on_male','vocabulary.turned_on_female','vocabulary.turned_on_other','vocabulary.turned_off_male','vocabulary.turned_off_female',
'vocabulary.turned_off_other','vocabulary.select_choose','vocabulary.search_no_results','vocabulary.enter_address','vocabulary.hello',
'vocabulary.not_applicable','vocabulary.pnts','vocabulary.column','vocabulary.columns','vocabulary.langs.pl',
'vocabulary.langs.en','formforge::components.buttons.save','formforge::components.buttons.choose_file','formforge::components.buttons.enter_address','formforge::components.typography.bold',
'formforge::components.typography.italic','formforge::components.typography.hiperlink','formforge::components.typography.quote','formforge::components.typography.li','formforge::components.typography.ol',
'formforge::components.typography.link','formforge::components.typography.unlink','formforge::forms.placeholders.choose_daterange_from','formforge::forms.placeholders.choose_daterange_to','formforge::forms.placeholders.choose_date',
'formforge::forms.placeholders.choose_birthdate','formforge::forms.placeholders.choose_time','formforge::forms.placeholders.choose_datetime','formforge::forms.yes','formforge::forms.no',
