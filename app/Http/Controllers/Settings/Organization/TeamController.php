...
class TeamController extends SettingsController
{
    ...
    public function store(Request $request, TeamEditForm $form)
    {
        $form->validate();
    ...
    public function edit(Request $request, Team $team, TeamEditForm $form)
    {
        $this->addPageNav();
    ...
    public function update(Request $request, Team $team, TeamEditForm $form)
    {
        $form->validate();
